...
- 📁 [01_Learn_the_basics](solutions/01_Learn_the_basics)
  ...
  - 📁 [02_Patterns](solutions/01_Learn_the_basics/02_Patterns)
    ...
    - 📄 [pattern_13.py](solutions/01_Learn_the_basics/02_Patterns/pattern_13.py) 🟢
    - 📄 [pattern_14.py](solutions/01_Learn_the_basics/02_Patterns/pattern_14.py) 🟢
    - 📄 [pattern_15.py](solutions/01_Learn_the_basics/02_Patterns/pattern_15.py) 🟢
    - 📄 [pattern_16.py](solutions/01_Learn_the_basics/02_Patterns/pattern_16.py) 🟢
  ...
  - 📁 [03_Know_Basic_Maths](solutions/01_Learn_the_basics/03_Know_Basic_Maths)
    - 📄 [check_for_prime_number.py](solutions/01_Learn_the_basics/03_Know_Basic_Maths/check_for_prime_number.py) 🟢
...
- 📁 [03_Solve_Problems_on_Arrays_Easy-Medium-Hard](solutions/03_Solve_Problems_on_Arrays_Easy-Medium-Hard)
  - 📁 [01_Easy](solutions/03_Solve_Problems_on_Arrays_Easy-Medium-Hard/01_Easy)
    ...
    - 📄 [longest_subarray_with_sum_k.py](solutions/03_Solve_Problems_on_Arrays_Easy-Medium-Hard/01_Easy/longest_subarray_with_sum_k.py) 🟡
    - 📄 [maximum_consecutive_ones.py](solutions/03_Solve_Problems_on_Arrays_Easy-Medium-Hard/01_Easy/maximum_consecutive_ones.py) 🟢
